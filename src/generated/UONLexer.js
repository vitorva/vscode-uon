...
class UONLexer extends Lexer_1.Lexer {
    ...
    // @Override
    get ruleNames() { return UONLexer.ruleNames; }
    // @Override
    get serializedATN() { return UONLexer._serializedATN; }
    // @Override
    get channelNames() { return UONLexer.channelNames; }
    // @Override
    get modeNames() { return UONLexer.modeNames; }
    // @Override
    ...
    NEWLINE2_action(_localctx, actionIndex) {
        switch (actionIndex) {
            case 0:
                if (ignoreWord)
                    this.skip();
    ...
    NEWLINE2_sempred(_localctx, predIndex) {
        switch (predIndex) {
            case 0:
    ...
    static get _ATN() {
        if (!UONLexer.__ATN) {
            UONLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(UONLexer._serializedATN));
        }
...
UONLexer.CT = 18;
UONLexer.METERS = 19;
UONLexer.KILOMETERS = 20;
UONLexer.GRAMS = 21;
UONLexer.KILOGRAMS = 22;
UONLexer.SECOND = 23;
UONLexer.MINUTE = 24;
UONLexer.CELSIUS = 25;
UONLexer.KELVIN = 26;
UONLexer.QUOTED_STRING = 27;
UONLexer.STR_TYPE = 28;
UONLexer.BOOL_TYPE = 29;
UONLexer.URL_TYPE = 30;
UONLexer.FLOAT_TYPE = 31;
UONLexer.FLOAT_128_TYPE = 32;
UONLexer.FLOAT_64_TYPE = 33;
UONLexer.FLOAT_32_TYPE = 34;
UONLexer.INT_TYPE = 35;
UONLexer.INT_128_TYPE = 36;
UONLexer.INT_64_TYPE = 37;
UONLexer.INT_32_TYPE = 38;
UONLexer.UINT_TYPE = 39;
UONLexer.UINT_128_TYPE = 40;
UONLexer.UINT_64_TYPE = 41;
UONLexer.UINT_32_TYPE = 42;
UONLexer.UNQUOTED_STRING = 43;
UONLexer.WS = 44;
UONLexer.NEWLINE2 = 45;
UONLexer.OPEN_PAR = 46;
UONLexer.CLOSE_PAR = 47;
UONLexer.OPEN_C_BRA = 48;
UONLexer.CLOSE_C_BRA = 49;
UONLexer.OPEN_S_BRA = 50;
UONLexer.CLOSE_S_BRA = 51;
UONLexer.COMMA = 52;
UONLexer.COLON = 53;
UONLexer.MAPPING_TYPE = 54;
UONLexer.SEQUENCE_TYPE = 55;
UONLexer.SCHEMA_TYPE = 56;
UONLexer.MINUS = 57;
// tslint:disable:no-trailing-whitespace
UONLexer.channelNames = [
...
UONLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(UONLexer._LITERAL_NAMES, UONLexer._SYMBOLIC_NAMES, []);
UONLexer._serializedATNSegments = 2;
UONLexer._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02;\u01F2\b\x01" +
...
UONLexer._serializedATNSegment1 = "\x07n\x02\x02\x99\x06\x03\x02\x02\x02\x9A\x9B\x07p\x02\x02\x9B\x9C\x07" +
...
UONLexer._serializedATN = Utils.join([
...
__decorate([
    Decorators_1.Override
], UONLexer.prototype, "nextToken", null);
